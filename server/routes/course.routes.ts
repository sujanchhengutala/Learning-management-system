...
import { addAnswer, addQestion, addReplyToReview, addReview, deleteCourse, editCourse, getAllCources, getAllCourse, getCourseByUser, getSingleCourse, uploadCourse } from "../controllers/course.controller";
...
courseRouter.get("/get-cources", isAuthenticate,authorizeRoles("admin"), getAllCources)
courseRouter.delete("/delete-course/:id", isAuthenticate,authorizeRoles("admin"), deleteCourse)
